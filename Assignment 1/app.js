...
function taskOne() {
    if (!blue) {
        color = 'blue';
        document.getElementById("answer-one").style.backgroundColor = color;
        blue = true;
    } else {
        color = 'white';
        document.getElementById("answer-one").style.backgroundColor = color;
...
function taskFive() {
    ...
    document.getElementById("answer-five").innerHTML = "<b>Skräp:</b> " + trash + "<br>" + "<b>Ätligt: </b>" + eatable;
...
function taskSix() {
    ...
    document.getElementById("answer-six").innerHTML = "<b>Under 30: </b>" + underThirty + "<br>" +
        "<b>Över 30:</b> " + overThirty + "<br> <b>Gift: </b>" + married + "<br> <b>Ogift:</b> " + notMarried;;
...
function taskSeven() {
    const result = addMeSomeLineBreaks.replace(/,/g, '<br>');
    document.getElementById("answer-seven").innerHTML = result;
}
...
/*
Uppgift 9: 
Om klockan är över17.00 ska bakgrundsfärgen ändras på alla divar med klassen 
...
function taskNine() {
    const date = new Date();
    var elements = document.getElementsByClassName('answer-container'); // get all elements
